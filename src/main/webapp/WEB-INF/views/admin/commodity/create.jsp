...
<head>
<title>广州精诚所至贸易有限公司后台管理系统</title>
		 ...
		 <form:form class="form-horizontal" id="cms-commodity-form" commandName="commodity">
			<fieldset>
				...
				<div class="control-group" id="cms-attribute-group">
					...
					<div class="controls row">
						<div class="span3">
							<input class="input-medium input-block-level cms-attribute-key" lang="001" type="text" placeholder="属性名称">
						</div>
						<div class="span4 cms-attribute-div" lang="001">
							<input class="input-medium input-block-level cms-attribute-value" lang="001" type="text"
								placeholder="属性值"> <a href="#none" lang="001"
								class="btn btn-primary cms-add-attribute" title="添加属性值"><i
									class="icon-plus icon-white"></i></a><br />
						</div>
					</div>
				</div>
			...
			<div class="control-group">
				...
				<!-- 数据域 -->
					...
					<input type="hidden" name="describe" id="cms-describe-data" value=""/>
				...
				<div class="form-actions">
					<a id="cms-commodity-from-submit" href="#none" class="btn btn-large btn-primary">发布产品</a>
