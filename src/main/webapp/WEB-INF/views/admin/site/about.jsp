...
<script type="text/javascript">
	...
	<div class="span12">
		 <form:form id="cms-company-form" class="form-horizontal" commandName="company">
			<fieldset>
				<legend>关于我们</legend>
				<div class="control-group">
					<label class="control-label" for="input01">企业名称</label>
					<div class="controls">
						<form:input path="companyName" class="input-block-level" placeholder="请输入企业名称..."/>
						<form:hidden path="companyIntro" id="companyIntro"/>
					</div>
				</div>
				
				
				<div class="control-group">
					<label class="control-label" for="input01">企业简介</label>
					<div class="controls">
						...
						<div id="companyIntroEditor">${company.companyIntro }</div>
					</div>
				</div>
				

				<div class="form-actions">
					<a type="button" href="#none" id="cms-aboutus-submit" class="btn btn-primary">保存更改</a>
				</div>
			</fieldset>
		</form:form>
