...
/* qqshop focus */
#focus {width:520px; height:475px; overflow:hidden; position:relative;}
#focus ul {height:380px; position:absolute;}
#focus ul li {float:left; width:520px; height:475px; overflow:hidden; position:relative; background:#000;}
...
<body>
   ...
   <div class="frist"><img src="${ctx }/resources/images/fore/pic.jpg" width="21" height="18" />
        	<span class="gray"><a href="#">首页</a>></span><span><a href="#">产品详情</a>></span>
        </div>
<div class="details">
  <h1>${commodity.commodityName }</h1>
					...
					<div id="focus">
						<ul style="margin-left: 28px">
							<c:forEach items="${commodity.images }" var="image">
								<li><a href="#none" ><img src="${ctx }${image.path}" style="width: 520px; height: 452px;" alt="asdf"/></a></li>
							</c:forEach>
						</ul>
					</div>
           ...
           <div class="introduce">
           		<c:forEach items="${commodity.attributes }" var="attribute">
	        		<div class="text_1">
	               		<div class="advocate">${attribute.name }：</div>
	                	<div class="order">${attribute.values[0].name }</div>
	                </div>
           		</c:forEach>
                   
           </div>
           <div class="explain" style="background-color: white;width: 897px;margin-left: -8px;"><p>产品说明：</p>
           ${commodity.described }
   
<div class="foot_commodity">
    		<p><a href="${ctx}/">首页</a> | <a href="${ctx}/aboutus.do">关于我们</a> | <a href="${ctx}/contactus.do"> 联系我们</a></p>
</div> 
<div class="content_bottom" style="margin-left: -31px"></div>
</div>
