...
<div class="content">
    	<h1>产品展示</h1>
          <div class="product">
          		<c:forEach items="${commoditys.result }" var="commodity" varStatus="index">
          			<c:choose>
          				<c:when test="${index.index % 3 == 0 }">
                            ...
                            <h2><a href="${ctx }/commodity.do?id=${commodity.id }" style="color: #58AF07;">${commodity.commodityName }</a></h2>
